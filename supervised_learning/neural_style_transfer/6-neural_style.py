#!/usr/bin/env python3
"""
Module to calculate Neural Style Transfer content cost
"""
import numpy as np
...
class NST:
    ...
    def content_cost(self, content_output):
        ...
        Parameters:
            content_output: tf.Tensor/tf.Variable containing the content
                            output for the generated image

        Returns:
            cost: tf.Tensor containing the content cost
        """
        # Hədəf struktur xüsusiyyətinin ölçüsünü (shape) götürürük
        s_shape = self.content_feature.shape

        # Tensor/Variable növü və hədəf forma ilə üst-üstə düşməsi yoxlanılır
        ...
        # İki struktur xüsusiyyəti arasındakı MSE-ni hesablayırıq
